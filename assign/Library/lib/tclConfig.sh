...
# installed.
TCL_PREFIX='E:/iit class/MLOPS/Assignmet1/assign\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='E:/iit class/MLOPS/Assignmet1/assign\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='E:/iit class/MLOPS/Assignmet1/assign\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-IE:/iit class/MLOPS/Assignmet1/assign\Library\include'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LE:/iit class/MLOPS/Assignmet1/assign\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='E:/iit class/MLOPS/Assignmet1/assign\Library\lib\tclstub86.lib'
